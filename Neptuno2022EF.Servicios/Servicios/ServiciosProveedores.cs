...
namespace Neptuno2022EF.Servicios.Servicios
{
    public class ServiciosProveedores:IServiciosProveedores
    {
        ...
        {
            return _repositorio.Exist(supplierId);
        }
        ...
        {
            return _repositorio.GetSuppliersByPage(actualPage, elementsByPage);
        }
        ...
        {
            return _repositorio.GetSuppliersByPageAndCondition(filterCondition, actualPage, elementsByPage);
        }

        public List<SupplierProductsDtoList> GetSuppliersWithTotalProducts()
        {
            return _repositorio.GetSuppliersWithTotalProducts();
        }
